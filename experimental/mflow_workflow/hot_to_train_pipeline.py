...
modelpipeline = Pipeline(
    steps=[
        ("feature_minmaxscaler", feature_minmaxscaler),
        ("sk_model", sk_model),
        ("target_minmaxscaler", target_minmaxscaler),
    ]
)
...
# modelpipeline.fit(features_train, target_train)


sk_model.score(features_train, target_train)

# >>> modelpipeline.predict(features_test)
# Traceback (most recent call last):
#   File "<stdin>", line 1, in <module>
#   File "/home/heiko/Schreibtisch/Repos/dash_apps/mlflow_workflow_app/.venv/lib/python3.10/site-packages/sklearn/utils/_available_if.py", line 31, in __get__
#     if not self.check(obj):
#   File "/home/heiko/Schreibtisch/Repos/dash_apps/mlflow_workflow_app/.venv/lib/python3.10/site-packages/sklearn/pipeline.py", line 44, in check
